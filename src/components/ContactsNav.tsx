...
const ContactsNav = () => {
  ...
  const inactive: string =
    "py-3 p-3 bg-[#374151] no-underline rounded hover:bg-[#0e7490]";
    ...
    <header className="flex justify-center mt-10">
      <nav>
        <ul className="flex gap-x-5">
          <li>
            <NavLink to="/contacts" end className={activeClassHandler}>
              All Contacts
            </NavLink>
          </li>
          <li>
            <NavLink to={"new"} className={activeClassHandler}>
              Create Contact
            </NavLink>
          </li>
        </ul>
